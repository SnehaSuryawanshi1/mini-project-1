		...
		int k;
			...
			k=rs.getInt(1)+1;
               System.out.println(k);
                ...
                String s20 = "";
                String s21 = "";
		//String sql="insert into problemrequest(TICKET,CATEGORYID,MODULEID,PROBLEMDESCRIPTION,LASTSOLUTION,USER_ID,PROBLEMREPORTDATE) values (" + k + ",'" + s1 + "','" + s3 + "','" + s5 + "','" + s17 + "','" + s6 + "','" + s15 + "')";
		// int l = st1.executeUpdate(sql);
		int l=st1.executeUpdate("insert into problemrequest values(" + k + ",'" + s1 + "','" + s3 + "','" + s5 + "','" + s17 + "','" + s6 + "','" + s15 + "','"+s20+"','"+s21+"')");
